[![RU](https://user-images.githubusercontent.com/9499881/27683795-5b0fbac6-5cd8-11e7-929c-057833e01fb1.png)](https://github.com/r57zone/Notifications/blob/master/README.md) 
...
4. Название файла иконки, расположенной слева (90 x 90 пикселей). Нужно добавить файл (png, jpg, bmp или gif) в папку "Icons". Если не нужна, то написать "null";<br>
5. Название файла иконки, расположенной справа (30 x 30 пикселей). Нужно добавить файл (png, jpg, bmp или gif) в папку "Icons". Если не нужна, то написать "null";<br>
6. Цвет темы в цифрах, от 0 до 7; По умолчанию это тема 0. Светло-синий - 0, Темно-синий - 1, Сине-зеленый - 2, Зеленый - 3, Фиолетовый - 4, Темно-розовый - 5, Красный - 6, Черный - 7;<br> 
