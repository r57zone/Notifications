...
1) Заголовок уведомления (полужирный шрифт);<br>
2) Первая строка;<br>
3) Вторая строка;<br>
4) Название файлы иконки справа (30 на 30 пикселей), закинуть в папку с приложением файл формата png, jpg, bmp или gif. Если не нужна, то написать "null";<br>
5) Название файлы иконки слева (90 на 900 пикселей), закинуть в папку с приложением файл формата png, jpg, bmp или gif. Если не нужна, то написать "null";<br>
